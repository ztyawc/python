...
sign_api = 'http://119.91.133.119:9000/jd/sign'  # sign接口地址
...
cks = [
    {
        'name': "测试",  # 账号1名
        'ck': "pin=jd_5b4d77668a5a3;wskey=AAJisT7PAEC618Q9M0hUu9FoZYCZl-e0LfOUd422Ofa1WaBTNN6tpFYRCTFOW6WhhYLsBAO7f5BMtwO0F4vBc1wTYAA2ayUB;",  # wskey
        'request': [],
